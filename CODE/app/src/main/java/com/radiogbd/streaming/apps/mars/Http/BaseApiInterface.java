...
public interface BaseApiInterface {
    ...
    Call<ResponseBody> checkStatus(@Header("Authorization") String key, @Body RequestBody jsonObject);

    @POST("subscription/1")
    Call<ResponseBody> makeWeeklySubscription(@Header("Authorization") String key, @Body RequestBody jsonObject);

    @POST("unsubscription")
    Call<ResponseBody> unsubscription(@Header("Authorization") String key, @Body RequestBody jsonObject);
