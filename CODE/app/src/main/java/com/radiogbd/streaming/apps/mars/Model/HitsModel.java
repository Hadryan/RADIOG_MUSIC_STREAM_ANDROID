...
public class HitsModel {
    ...
    public HitsModel(int id){
        this.id = id;
    }

    public HitsModel(int id, String title, String title_bn, String artist, String artist_bn, String album, String album_bn, String lyrics, String lyrics_bn, String tune, String tune_bn, String link, String tokenFav, String thumbnail) {
        this.id = id;
        this.title = title;
    ...
    public HitsModel(int id, String title, String title_bn, String artist, String artist_bn, String album, String album_bn, String lyrics, String lyrics_bn, String tune, String tune_bn, String link, String tokenFav, String thumbnail, String premium) {
        this.id = id;
        this.title = title;
        this.title_bn = title_bn;
        this.artist = artist;
